"""
URL configuration for django_faculdade_site project.
...
from django_faculdade_site.apps.add_user.views import add_user, rem_user
...
urlpatterns = [
    ...
    path(route="accounts/rem_user/<id_user>/", view=rem_user, name="rem_user"),
